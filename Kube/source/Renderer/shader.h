...
//! \todo Improve support for uniform variables by querying shader and overloading method
...
public:
    ...
    */
     ...
     * \param value Value to set uniform variable to
     */
    void setUniform3f(GLchar const* location, float value1, float value2, float value3);
     ...
     * \param value Value to set uniform variable to
     */
    void setUniform4f(GLchar const* location, float value1, float value2, float value3, float value4);
   ...
   */
    ...
    * \param value Value to set uniform variable to
    */
   void setUniform4i(GLchar const* location, int value1, int value2, int value3, int value4);
