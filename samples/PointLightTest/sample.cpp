								...
								for (int x = 0; x < ChunkManager::CHUNK_SIZE; x++) {
																for (int z = 0; z < ChunkManager::CHUNK_SIZE; z++) {
																								for (int y = 0; y < ChunkManager::CHUNK_SIZE; y++) {
																																if ((sqrt((z - ChunkManager::CHUNK_SIZE / 2) * (z - ChunkManager::CHUNK_SIZE / 2) + (x - ChunkManager::CHUNK_SIZE / 2) * (x - ChunkManager::CHUNK_SIZE / 2) + (y - ChunkManager::CHUNK_SIZE / 2) * (y - ChunkManager::CHUNK_SIZE / 2))) < ChunkManager::CHUNK_SIZE / 2) {
