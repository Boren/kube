...
public:
    ...
    void setColorPalette(std::vector<unsigned int> colorPalette);

    const std::vector<unsigned int> defaultColorPalette = {
...
private:
    ...
    bool _useCustomColorPalette = false;
    std::vector<unsigned int> _colorPalette;
