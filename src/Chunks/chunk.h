...
private:
     ...
     */
	void createBlockMesh(Block* block, glm::ivec3 blockCoord, glm::ivec3 blockCoordLocal);
     ...
     */
    void createFaceMesh(glm::vec3 normal, glm::vec3 p1, glm::vec3 p2, glm::vec3 p3, glm::vec3 p4, glm::vec4 color, glm::ivec3 blockCoordLocal);

	int getAmbientOcclusionAtVertex(glm::vec3 position, glm::vec3 normalDirection, glm::vec3 direction1, glm::vec3 direction2);
