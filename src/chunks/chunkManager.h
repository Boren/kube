...
public:
  //! Default Constructor
  /*!
    \param loadDistance Integer designating how many chunks should be loaded
    from camera position.
    \param viewDistance Integer designating how many chunks should be visible
    from camera position.
    \remark Setting view distance lower than load distance limits view distance
    to load distance.
  */
  ...
  /*!
    ...
    \param camera Reference to camera object containing information about
    current viewport.
...
private:
  ...
  std::function<void(Chunk *)>
      callback_loadChunk; //!< Function to be called when chunk is to be loaded
